...
int pm_calculate_energy( counter_t pm_counter, line_t lines, double ** energy, double * aggregate_energy);
...
/*
void handler(int senyal){
	//printf("Voy a terminar\n");
	counter_t *current_counter, *tmp;
  	
  	HASH_ITER(hh, pm_counter_list, current_counter, tmp) {
 // 		pm_finalize_counter(current_counter);  
	} 
}
*/
